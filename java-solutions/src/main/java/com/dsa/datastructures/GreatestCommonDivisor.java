...
public class GreatestCommonDivisor{
     ...
     * 
     * Concept:
     *     The GCD of two numbers is the largest positive integer that divides both numbers without 
     *     a remainder. The Euclidean Algorithm operates on the principle that the GCD of two 
     *     numbers also divides their difference. Specifically: gcd(a, b) = gcd(b, a % b).
     * 
     * The Logic:
     ...
     *     3. Simplicity: It avoids unnecessary "if (a < b)" checks as the modulo operator 
